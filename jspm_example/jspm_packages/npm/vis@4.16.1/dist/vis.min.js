    ...
    return function(t) {
      ...
      e.addCssText = function(t, i) {
        ...
        for (var s,
          ...
          if (h = Math.floor(.5 * (u + c)), s = t[Math.max(0, h - 1)][i], r = t[h][i], a = t[Math.min(t.length - 1, h + 1)][i], 0 == n(r, e))
            return h;
          if (n(s, e) < 0 && n(r, e) > 0)
        ...
        !function(e, i) {
          ...
          function D(t, e) {
            var i,
                o = a({}, t);
            for (i in e)
              r(e, i) && (O(t[i]) && O(e[i]) ? (o[i] = {}, a(o[i], t[i]), a(o[i], e[i])) : null != e[i] ? o[i] = e[i] : delete o[i]);
            return o;
          }
          function S(t) {
            null != t && this.set(t);
          ...
          function E(e) {
            var i = null;
            if (!mo[e] && "undefined" != typeof t && t && t.exports)
              try {
                i = po._abbr, !function() {
          ...
          function N(t, e) {
            if (null != e) {
              ...
              null != mo[t] && (null != mo[t].parentLocale ? mo[t] = mo[t].parentLocale : null != mo[t] && delete mo[t]);
            return mo[t];
          }
          function R(t) {
            var e;
          ...
          function St(t) {
            var e,
                ...
                s = [];
            if (!t._d) {
              for (o = Dt(t), t._w && null == t._a[Wo] && null == t._a[Ho] && Ct(t), t._dayOfYear && (n = Mt(t._a[jo], o[jo]), t._dayOfYear > yt(n) && (l(t)._overflowDayOfYear = !0), i = gt(n, 0, t._dayOfYear), t._a[Ho] = i.getUTCMonth(), t._a[Wo] = i.getUTCDate()), e = 0; 3 > e && null == t._a[e]; ++e)
                t._a[e] = s[e] = o[e];
              for (; 7 > e; e++)
          ...
          function Tt(t) {
            ...
            var i,
                ...
                h = a.length,
                d = 0;
            for (n = X(t._f, t._locale).match(go) || [], i = 0; i < n.length; i++)
              s = n[i], o = (a.match(K(s, t)) || [])[0], o && (r = a.substr(0, a.indexOf(o)), r.length > 0 && l(t).unusedInput.push(r), a = a.slice(a.indexOf(o) + o.length), d += o.length), wo[s] ? (o ? l(t).empty = !1 : l(t).unusedTokens.push(s), et(s, o, t)) : t._strict && !o && l(t).unusedTokens.push(s);
          ...
          function Pt(t) {
            ...
            for (n = 0; n < t._f.length; n++)
              s = 0, e = f({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[n], Tt(e), c(e) && (s += l(e).charsLeftOver, s += 10 * l(e).unusedTokens.length, l(e).score = s, (null == o || o > s) && (o = s, i = e));
            a(t, i || e);
          }
          function It(t) {
            if (!t._d) {
      ...
      o.prototype.setOptions = function(t) {
        ...
        var d,
            ...
            v = [];
        if (void 0 != e)
          d = n._getItem(e, f), d && m && !m(d) && (d = null);
        else if (void 0 != i)
          for (u = 0, p = i.length; p > u; u++)
            d = n._getItem(i[u], f), m && !m(d) || v.push(d);
        else
          for (l = Object.keys(this._data), u = 0, p = l.length; p > u; u++)
            c = l[u], d = n._getItem(c, f), m && !m(d) || v.push(d);
        if (o && o.order && void 0 == e && this._sort(v, o.order), o && o.fields) {
          var g = o.fields;
          if (void 0 != e)
            d = this._filterFields(d, g);
          else
            for (u = 0, p = v.length; p > u; u++)
              v[u] = this._filterFields(v[u], g);
        }
        if ("Object" == a) {
          var y,
              b = {};
        ...
        if (a)
          if (h) {
            ...
            for (this._sort(s, h), e = 0, i = s.length; i > e; e++)
              c.push(s[e][this._fieldId]);
          } else
            for (e = 0, i = l.length; i > e; e++)
              o = l[e], n = this._getItem(o, d), a(n) && c.push(n[this._fieldId]);
        else if (h) {
          for (s = [], e = 0, i = l.length; i > e; e++)
            o = l[e], s.push(r[o]);
          for (this._sort(s, h), e = 0, i = s.length; i > e; e++)
          ...
          for (e = 0, i = l.length; i > e; e++)
            o = l[e], n = r[o], c.push(n[this._fieldId]);
        return c;
      ...
      o.prototype.setData = function(t) {
        ...
        if (a && h) {
          switch (t) {
            ...
            case "update":
              for (o = 0, n = a.length; n > o; o++)
                s = a[o], r = this.get(s), r ? this._ids[s] ? (c.push(s), d.push(e.data[o])) : (this._ids[s] = !0, l.push(s)) : this._ids[s] && (delete this._ids[s], u.push(s));
              break;
            case "remove":
              for (o = 0, n = a.length; n > o; o++)
      ...
      a(o.prototype), o.prototype._setScale = function() {
        ...
        if ("string" == typeof t)
          e = t, i = "none", o = 0;
        else if ("object" === ("undefined" == typeof t ? "undefined" : r(t)))
        ...
        if (this.style === o.STYLE.GRID || this.style === o.STYLE.SURFACE) {
          ...
          for (n = 0; n < this.getNumberOfRows(t); n++)
            e = t[n][this.colX] || 0, i = t[n][this.colY] || 0, -1 === d.indexOf(e) && d.push(e), -1 === l.indexOf(i) && l.push(i);
          var u = function(t, e) {
            return t - e;
          };
          d.sort(u), l.sort(u);
          ...
          for (n = 0; n < t.length; n++)
            a = new c, a.x = t[n][this.colX] || 0, a.y = t[n][this.colY] || 0, a.z = t[n][this.colZ] || 0, void 0 !== this.colValue && (a.value = t[n][this.colValue] || 0), r = {}, r.point = a, r.bottom = new c(a.x, a.y, this.zMin), r.trans = void 0, r.screen = void 0, h.push(r);
        return h;
        ...
        if (this.style === o.STYLE.DOTSIZE && (c.strokeStyle = this.axisColor, c.fillStyle = this.dataColor.fill, c.beginPath(), c.moveTo(h, r), c.lineTo(a, r), c.lineTo(a - i + e, d), c.lineTo(h, d), c.closePath(), c.fill(), c.stroke()), this.style === o.STYLE.DOTCOLOR || this.style === o.STYLE.DOTSIZE) {
          ...
          for (b.start(), b.getCurrent() < this.valueMin && b.next(); !b.end(); )
            t = d - (b.getCurrent() - this.valueMin) / (this.valueMax - this.valueMin) * s, c.beginPath(), c.moveTo(h - y, t), c.lineTo(h, t), c.stroke(), c.textAlign = "right", c.textBaseline = "middle", c.fillStyle = this.axisColor, c.fillText(b.getCurrent(), h - 2 * y, t), b.next();
        ...
        for (m.lineWidth = 1, o = void 0 === this.defaultYStep, i = new v(this.yMin, this.yMax, this.yStep, o), i.start(), i.getCurrent() < this.yMin && i.next(); !i.end(); )
          this.showGrid ? (t = this._convert3Dto2D(new c(this.xMin, i.getCurrent(), this.zMin)), e = this._convert3Dto2D(new c(this.xMax, i.getCurrent(), this.zMin)), m.strokeStyle = this.gridColor, m.beginPath(), m.moveTo(t.x, t.y), m.lineTo(e.x, e.y), m.stroke()) : (t = this._convert3Dto2D(new c(this.xMin, i.getCurrent(), this.zMin)), e = this._convert3Dto2D(new c(this.xMin + y, i.getCurrent(), this.zMin)), m.strokeStyle = this.axisColor, m.beginPath(), m.moveTo(t.x, t.y), m.lineTo(e.x, e.y), m.stroke(), t = this._convert3Dto2D(new c(this.xMax, i.getCurrent(), this.zMin)), e = this._convert3Dto2D(new c(this.xMax - y, i.getCurrent(), this.zMin)), m.strokeStyle = this.axisColor, m.beginPath(), m.moveTo(t.x, t.y), m.lineTo(e.x, e.y), m.stroke()), s = Math.sin(w) > 0 ? this.xMin : this.xMax, n = this._convert3Dto2D(new c(s, i.getCurrent(), this.zMin)), Math.cos(2 * w) < 0 ? (m.textAlign = "center", m.textBaseline = "top", n.y += b) : Math.sin(2 * w) > 0 ? (m.textAlign = "right", m.textBaseline = "middle") : (m.textAlign = "left", m.textBaseline = "middle"), m.fillStyle = this.axisColor, m.fillText("  " + this.yValueLabel(i.getCurrent()) + "  ", n.x, n.y), i.next();
        for (m.lineWidth = 1, o = void 0 === this.defaultZStep, i = new v(this.zMin, this.zMax, this.zStep, o), i.start(), i.getCurrent() < this.zMin && i.next(), s = Math.cos(w) > 0 ? this.xMin : this.xMax, r = Math.sin(w) < 0 ? this.yMin : this.yMax; !i.end(); )
          t = this._convert3Dto2D(new c(s, r, i.getCurrent())), m.strokeStyle = this.axisColor, m.beginPath(), m.moveTo(t.x, t.y), m.lineTo(t.x - b, t.y), m.stroke(), m.textAlign = "right", m.textBaseline = "middle", m.fillStyle = this.axisColor, m.fillText(this.zValueLabel(i.getCurrent()) + " ", t.x - 5, t.y), i.next();
      ...
      !function(n, s, r, a) {
        ...
        X.prototype = {
          ...
          preventDefaults: function(t) {
            if (!oe) {
              ...
              if (!r || !s)
                return n || s && i & Ft || r && i & jt ? this.preventSrc(e) : void 0;
            }
          },
        ...
        K.prototype = {
          ...
          inputTarget: null,
          inputClass: null,
          preset: [[nt, {enable: !1}], [it, {enable: !1}, ["rotate"]], [st, {direction: Ft}], [et, {direction: Ft}, ["swipe"]], [rt], [rt, {
            event: "doubletap",
            taps: 2
          }, ["tap"]], [ot]],
          cssProps: {
          ...
          recognize: function(t) {
            ...
            if (!e.stopped) {
              ...
              for (var s = 0; s < o.length; )
                i = o[s], e.stopped === ye || n && i != n && !i.canRecognizeWith(n) ? i.reset() : i.recognize(t), !n && i.state & (ce | ue | pe) && (n = e.curRecognizer = i), s++;
            }
          },
          get: function(t) {
            if (t instanceof K)
      ...
      n.prototype = new f, n.prototype._createConfigurator = function() {
        ...
        var e;
        e = t ? t instanceof c || t instanceof u ? t : new c(t, {type: {
            start: "Date",
            end: "Date"
            ...
            return n(t, [{
              ...
              value: function() {
                if (this.generated === !1) {
                  ...
                  for (s = 0; 360 > s; s++)
                    for (r = 0; r < this.r; r++)
                      o = this.centerCoordinates.x + r * Math.sin(h * s), n = this.centerCoordinates.y + r * Math.cos(h * s), c = a.HSVToRGB(s * d, r * l, 1), t.fillStyle = "rgb(" + c.r + "," + c.g + "," + c.b + ")", t.fillRect(o - .5, n - .5, 2, 2);
              ...
              value: function(e, i, o) {
                ...
                for (var c in i) {
                  ...
                  if (void 0 !== i[c].__type__ && n === !0) {
                    ...
                    -1 !== c.toLowerCase().indexOf(d) && (l = c), u = t.levenshteinDistance(e, c), s > u && (a = c, h = r.copyArray(o), s = u);
                }
                return {
                  closestMatch: a,
                  path: h,
      ...
      o.prototype = new h, o.prototype.setOptions = function(t) {
        ...
        if (this.props.touch.dragging && this.options.moveable && this.props.touch.allowDragging) {
          ...
          if (c != h || u != l)
            return this.deltaDifference += i, this.props.touch.start = c, this.props.touch.end = u, void this._onDrag(t);
          ...
          if (e && e != this.groupTouchParams.group) {
            ...
            if (!r.equalArray(c, this.groupTouchParams.originalOrder))
              for (var h = this.groupsData,
                  u = this.groupTouchParams.originalOrder,
                  p = this.groupTouchParams.group.groupId,
                  f = Math.min(u.length, c.length),
                  m = 0,
                  v = 0,
                  g = 0; f > m; ) {
                for (; f > m + v && f > m + g && c[m + v] == u[m + g]; )
                  m++;
                if (m + v >= f)
                  break;
                if (c[m + v] != p)
      ...
      o.prototype._create = function() {
        ...
        for (var u = 0,
            p = this.visibleItems.length; p > u; u++) {
      ...
      n.prototype = new f, n.prototype.setOptions = function(t) {
        ...
        if (e = t ? t instanceof c || t instanceof u ? t : new c(t, {type: {
            start: "Date",
            end: "Date"
      ...
      o.prototype = new d, o.prototype._create = function() {
            ...
            for (e = 0; e < a.length; e++)
              if (t = this.groups[a[e]], "line" === t.options.style && 1 == t.options.shaded.enabled) {
                ...
                if (l.hasOwnProperty(a[e]) || (l[a[e]] = f.calcPath(c, t)), "group" === t.options.shaded.orientation) {
                  ...
                  f.drawShading(l[a[e]], t, void 0, this.framework);
              }
        ...
        if (t.length > 0) {
          ...
          for (var c = 0; c < t.length; c++)
            e.hasOwnProperty(t[c]) && e[t[c]].ignore !== !0 && (i = e[t[c]].min, o = e[t[c]].max, "right" != e[t[c]].yAxisOrientation ? (s = !0, a = a > i ? i : a, d = o > d ? o : d) : (r = !0, h = h > i ? i : h, l = o > l ? o : l));
        ...
        for (var p = ["__barStackLeft", "__barStackRight", "__lineStackLeft", "__lineStackRight"],
            c = 0; c < p.length; c++)
          -1 != t.indexOf(p[c]) && t.splice(t.indexOf(p[c]), 1);
        return n;
      ...
      i.prototype.setCharHeight = function(t) {
        ...
        for (var a = (t.getLines(), t.convertValue(0)),
          ...
          if (this.zeroAlign) {
            ...
            this.autoScaleStart ? (this._start -= f / this.scale, this._end = this._start + c) : (this._start += p - f / this.scale, this._end = this._start + c);
      ...
      o.drawIcon = function(t, e, i, o, s, r) {
        ...
        if (0 !== f)
          for (u.sort(function(t, e) {
            ...
            var v = 0;
            if (void 0 === p[a])
              l + 1 < u.length && (r = Math.abs(u[l + 1].screen_x - a)), h = o._getSafeDrawData(r, d, m);
            else {
            ...
            return s(t, [{
              ...
              value: function(t, e) {
                ...
                if (A.selectiveNotDeepExtend(n, t, e, i), A.mergeOptions(t, e, "shadow", i, o), void 0 !== e.color && null !== e.color) {
                  ...
                  i === !0 && null === e.color && (t.color = A.bridgeObject(o.color));
            ...
            return r(t, [{
              ...
              value: function(t, e) {
                ...
                if ("string" == typeof e.font) {
                  ...
                  "object" === s(e.font) && a.fillIfDefined(t, e.font, i);
              ...
              value: function(t) {
                if (0 != this.imageObj.width) {
                  ...
                  if (e > 2 && this.options.shapeProperties.interpolation === !0) {
                    ...
                    for (var r = 0,
                        a = 1; e > 2 && 4 > a; )
                      s.drawImage(n, r, 0, i, o, r + i, 0, i / 2, o / 2), r += i, e *= .5, i *= .5, o *= .5, a += 1;
                    t.drawImage(n, r, 0, i, o, this.left, this.top, this.width, this.height);
                  } else
                    t.drawImage(this.imageObj, this.left, this.top, this.width, this.height);
            ...
            return r(t, [{
              ...
              value: function(t, e) {
                ...
                if (void 0 !== e.color && null !== e.color)
                  if (t.color = g.deepExtend({}, t.color, !0), g.isString(e.color))
                  ...
                  i === !0 && null === e.color && (t.color = g.bridgeObject(o.color));
            ...
            return r(e, t), a(e, [{
              ...
              value: function(t, e, i, o, n, s, r, a) {
                var h = 1e9,
                    ...
                    v = [0, 0, 0, 0];
                for (l = 1; 10 > l; l++)
                  c = .1 * l, v[0] = Math.pow(1 - c, 3), v[1] = 3 * c * Math.pow(1 - c, 2), v[2] = 3 * Math.pow(c, 2) * (1 - c), v[3] = Math.pow(c, 3), u = v[0] * t + v[1] * r.x + v[2] * a.x + v[3] * i, p = v[0] * e + v[1] * r.y + v[2] * a.y + v[3] * o, l > 0 && (d = this._getDistanceToLine(f, m, u, p, n, s), h = h > d ? d : h), f = u, m = p;
                return h;
              }
            }]), e;
          }(d["default"]);
            ...
            return r(e, t), a(e, [{
              ...
              value: function(t, e) {
                ...
                for (t.id === this.from.id && (p = this.from, f = !0); c >= l && h > d; ) {
                  var m = .5 * (l + c);
                  if (i = this.getPoint(m, a), o = Math.atan2(p.y - i.y, p.x - i.x), n = p.distanceToBorder(e, o), s = Math.sqrt(Math.pow(i.x - p.x, 2) + Math.pow(i.y - p.y, 2)), r = n - s, Math.abs(r) < u)
                    break;
              ...
              value: function(t, e, i, o, n, s, r) {
                var a = 1e9,
                    ...
                    f = e;
                for (d = 1; 10 > d; d++)
                  l = .1 * d, c = Math.pow(1 - l, 2) * t + 2 * l * (1 - l) * r.x + Math.pow(l, 2) * i, u = Math.pow(1 - l, 2) * e + 2 * l * (1 - l) * r.y + Math.pow(l, 2) * o, d > 0 && (h = this._getDistanceToLine(p, f, c, u, n, s), a = a > h ? h : a), p = c, f = u;
                return a;
              }
            }]), e;
          }(d["default"]);
            ...
            return s(t, [{
              ...
              value: function(t, e, i) {
                for (var o = i.x,
                    ...
                    m = void 0,
                    v = .05,
                    g = .5 * (s + r); r >= s && h > d && (g = .5 * (s + r), c = this._pointOnCircle(o, n, l, g), u = Math.atan2(t.y - c.y, t.x - c.x), p = t.distanceToBorder(e, u), f = Math.sqrt(Math.pow(c.x - t.x, 2) + Math.pow(c.y - t.y, 2)), m = p - f, !(Math.abs(m) < v)); )
            ...
            return s(t, [{
              ...
              value: function() {
                ...
                for (var r in this.physicsBody.velocities)
                  void 0 === t[r] && delete this.physicsBody.velocities[r];
              }
            }, {
              key: "revert",
              value: function() {
          ...
          n = function() {
            ...
            return o(t, [{
              ...
              value: function(t, e) {
                ...
                for (var y = 0; o > y; y++)
                  i = t[e[y]], i.options.mass > 0 && this._placeInTree(g.root, i);
                return g;
              }
            }, {
              ...
              value: function() {
                for (var t,
                  ...
                  for (var m = f + 1; m < d.length; m++)
                    a = h[d[m]], t = a.x - r.x, e = a.y - r.y, i = Math.sqrt(t * t + e * e), 0 === i && (i = .1 * Math.random(), t = i), 2 * c > i && (s = .5 * c > i ? 1 : u * i + p, s /= i, o = t * s, n = e * s, l[r.id].x -= o, l[r.id].y -= n, l[a.id].x += o, l[a.id].y += n);
                }
              }
            }]), t;
          }();
            ...
            return o(t, [{
              ...
              value: function() {
                ...
                for (var m = 0; m < l.length; m++)
                  e = h[l[m]], e.connected === !0 && (t = void 0 === e.options.length ? this.options.springLength : e.options.length, i = e.from.x - e.to.x, o = e.from.y - e.to.y, a = Math.sqrt(i * i + o * o), a = 0 === a ? .01 : a, r = this.options.springConstant * (t - a) / a, n = i * r, s = o * r, e.to.level != e.from.level ? (void 0 !== u[e.toId] && (u[e.toId].springFx -= n, u[e.toId].springFy -= s), void 0 !== u[e.fromId] && (u[e.fromId].springFx += n, u[e.fromId].springFy += s)) : (void 0 !== u[e.toId] && (u[e.toId].x -= d * n, u[e.toId].y -= d * s), void 0 !== u[e.fromId] && (u[e.fromId].x += d * n, u[e.fromId].y += d * s)));
                for (var v,
                    g,
                    r = 1,
                    y = 0; y < c.length; y++) {
            ...
            return r(t, [{
              ...
              value: function(t, e) {
                ...
                for (var o = [],
                  ...
                  if (d = this.body.nodeIndices[c], void 0 === n[d]) {
                    ...
                    for (var f = 0; f < a.edges.length; f++)
                      s = a.edges[f], void 0 === this.clusteredEdges[s.id] && (s.toId !== s.fromId && l++, r.push(s));
                    if (l === t) {
                      for (var m = !0,
                          v = 0; v < r.length; v++) {
                        s = r[v];
                        ...
                        if (void 0 === e.joinCondition)
                          p[s.id] = s, u[d] = this.body.nodes[d], u[g] = this.body.nodes[g], n[d] = !0;
                        else {
                ...
                for (var b = 0; b < o.length; b++)
                  this._cluster(o[b].nodes, o[b].edges, e, !1);
              ...
              value: function(t, e, i, o) {
                for (var n = void 0,
                  ...
                  for (var m = 0; m < r.edges.length; m++)
                    n = r.edges[m], void 0 === this.clusteredEdges[n.id] && (n.toId == n.fromId ? e[n.id] = n : n.toId == s ? (a = i.id, d = n.fromId, l = d) : (a = n.toId, d = i.id, l = a), void 0 === t[l] && p.push({
                      edge: n,
                      fromId: d,
                      toId: a
                    }));
              ...
              value: function(t, e, i) {
                ...
                if (!(Object.keys(t).length < 2)) {
                  ...
                  for (var w in t)
                    t.hasOwnProperty(w) && (this.clusteredNodes[w] = {
                      clusterId: s.id,
              ...
              value: function(t, e) {
                ...
                for (var I in s)
                  s.hasOwnProperty(I) && this._restoreEdge(s[I]);
            ...
            return s(t, [{
              ...
              value: function(t, e) {
                ...
                for (var s = 0; s < e.nodes.length; s++)
                  -1 === t.nodes.indexOf(t.nodes[s]) && (i = !0);
                for (var r = 0; r < t.edges.length; r++)
                  -1 === e.edges.indexOf(t.edges[r]) && (o = !0);
                for (var a = 0; a < e.edges.length; a++)
                  -1 === t.edges.indexOf(t.edges[a]) && (o = !0);
                return {
                  nodesChanged: i,
                  edgesChanged: o
                };
              ...
              value: function(t) {
                ...
                if (void 0 === this.popupObj && s === !1) {
                  for (var p = this.body.edgeIndices,
                      ...
                      v = [],
                      g = 0; g < p.length; g++)
                    m = f[p[g]], m.isOverlappingWith(o) === !0 && m.connected === !0 && void 0 !== m.getTitle() && v.push(p[g]);
            ...
            return s(t, [{
              ...
              value: function(t) {
                ...
                for (var i in this.hoverObj.nodes)
                  this.hoverObj.nodes.hasOwnProperty(i) && (void 0 === t || t instanceof a["default"] && t.id != i || t instanceof d["default"]) && (this.blurObject(this.hoverObj.nodes[i]), delete this.hoverObj.nodes[i], e = !0);
            ...
            return a(t, [{
              ...
              value: function(t, e) {
                if (void 0 !== t) {
                  ...
                  if (l.selectiveDeepExtend(["randomSeed", "improvedLayout"], this.options, t), l.mergeOptions(this.options, t, "hierarchical"), void 0 !== t.randomSeed && (this.initialRandomSeed = t.randomSeed), this.options.hierarchical.enabled === !0)
                  ...
                  if (i === !0)
                    return this.body.emitter.emit("refresh"), l.deepExtend(e, this.optionsBackup);
                }
                return e;
              }
            }, {
              ...
              key: "_shiftToCenter",
              value: function() {
                for (var t = d["default"].getRangeCore(this.body.nodes, this.body.nodeIndices),
                    e = d["default"].findCenter(t),
                ...
                var t = this,
                      ...
                      for (var n = 0; n < i.length; n++) {
                        ...
                        if (r.length > 1)
                          for (var a = 0; a < r.length - 1; a++)
                            u(r[a], r[a + 1]) === !0 && t.hierarchicalTrees[r[a].id] === t.hierarchicalTrees[r[a + 1].id] && e(r[a], r[a + 1], o);
                      }
                    },
                    f = function(i, o) {
                      var n = arguments.length <= 2 || void 0 === arguments[2] ? !1 : arguments[2],
                    ...
                    m = function(o, n) {
                      for (var r = n.id,
                          ...
                          c = t.options.hierarchical.levelSeparation * t.options.hierarchical.levelSeparation,
                          u = {},
                          p = [],
                          f = 0; f < a.length; f++) {
                        var m = a[f];
              ...
              value: function(t) {
                if (this.hierarchicalParentReference[t.id])
                  for (var e = this.hierarchicalParentReference[t.id],
                      i = 0; i < e.length; i++) {
                    var o = e[i],
                        n = this.body.nodes[o];
              ...
              value: function(t, e) {
                if (void 0 !== this.hierarchicalChildrenReference[t]) {
                  for (var i = [],
                      o = 0; o < this.hierarchicalChildrenReference[t].length; o++)
                    i.push(this.body.nodes[this.hierarchicalChildrenReference[t][o]]);
                  this._sortNodeArray(i);
                  for (var n = 0; n < i.length; n++) {
                    var s = i[n],
                        r = this.hierarchicalLevels[s.id];
                    if (!(r > e && void 0 === this.positionedNodes[s.id]))
                      return;
                    var a = void 0;
              ...
              value: function() {
                ...
                for (var i in this.body.nodes)
                  this.body.nodes.hasOwnProperty(i) && void 0 !== this.hierarchicalLevels[i] && (this.hierarchicalLevels[i] -= t);
              }
            }, {
              key: "_generateMap",
              value: function() {
                    ...
                    s = function d(i, n) {
                      if (void 0 === o[i.id]) {
                        ...
                        for (var s = void 0,
                          ...
                          i.edges[r].connected === !0 && (s = i.edges[r].toId === i.id ? i.edges[r].from : i.edges[r].to, i.id !== s.id && (e(i, s, i.edges[r]), d(s, n)));
                      }
                    };
                if (void 0 === i)
              ...
              value: function(t, e) {
                if ("UD" === this.options.hierarchical.direction || "DU" === this.options.hierarchical.direction ? this.body.nodes[t].x += e : this.body.nodes[t].y += e, void 0 !== this.hierarchicalChildrenReference[t])
                  for (var i = 0; i < this.hierarchicalChildrenReference[t].length; i++)
                    this._shiftBlock(this.hierarchicalChildrenReference[t][i], e);
              }
            }, {
        ...
        return function(e, i, o) {
          ...
          h = function() {
            ...
            return n(t, [{
              ...
              value: function(t) {
                if (this.options.rtl)
                  var e = "vis-button vis-delete-rtl";
                else
                  var e = "vis-button vis-delete";
            ...
            return o(t, [{
              ...
              value: function(t, e, i) {
                ...
                for (var d = e.length,
                  ...
                  for (var c = 0; d - 1 > c; c++)
                    for (var u = c + 1; d > u; u++)
                      o[e[c]][e[u]] = Math.min(o[e[c]][e[u]], o[e[c]][e[l]] + o[e[l]][e[u]]), o[e[u]][e[c]] = o[e[c]][e[u]];
                return o;
              }
            }]), t;
          }();
      ...
      "undefined" != typeof CanvasRenderingContext2D && (CanvasRenderingContext2D.prototype.circle = function(t, e, i) {
        ...
        for (var s = n.length,
            ...
            u = 0,
            p = n[0]; d >= .1; )
          p = n[l++ % s], p > d && (p = d), u = Math.sqrt(p * p / (1 + h * h)), u = 0 > r ? -u : u, t += u, e += h * u, c === !0 ? this.lineTo(t, e) : this.moveTo(t, e), d -= p, c = !c;
      });
    }, function(t, e) {
      function i(t) {
        return P = t, p();
      ...
      function u() {
        ...
        if ("" === N)
          return void(z = T.DELIMITER);
        var i = N + s();
        if (E[i])
          return z = T.DELIMITER, R = i, n(), void n();
        if (E[N])
          return z = T.DELIMITER, R = N, void n();
        if (r(N) || "-" === N) {
          for (R += N, n(); r(N); )
            R += N, n();
        ...
        if ('"' === N) {
          for (n(); "" != N && ('"' != N || '"' === N && '"' === s()); )
            R += N, '"' === N && n(), n();
          if ('"' != N)
            throw _('End of string " expected');
      ...
      function p() {
        var t = {};
        if (o(), u(), "strict" === R && (t.strict = !0, u()), "graph" !== R && "digraph" !== R || (t.type = R, u()), z === T.IDENTIFIER && (t.id = R, u()), "{" != R)
          throw _("Angle bracket { expected");
        if (u(), f(t), "}" != R)
          throw _("Angle bracket } expected");
        if (u(), "" !== R)
          throw _("End of file expected");
      ...
      function v(t) {
        ...
        if ("subgraph" === R && (e = {}, e.type = "subgraph", u(), z === T.IDENTIFIER && (e.id = R, u())), "{" === R) {
          if (u(), e || (e = {}), e.parent = t, e.node = t.node, e.edge = t.edge, e.graph = t.graph, f(e), "}" != R)
            throw _("Angle bracket } expected");
      ...
      function b(t, e) {
        for (; "->" === R || "--" === R; ) {
          ...
          if (n)
            ...
            if (z != T.IDENTIFIER)
              throw _("Identifier or subgraph expected");
            i = R, d(t, {id: i}), u();
          }
          var s = w(),
              r = c(t, e, i, o, s);
      ...
      function w() {
        for (var t = null; "[" === R; ) {
          for (u(), t = {}; "" !== R && "]" != R; ) {
            if (z != T.IDENTIFIER)
              throw _("Attribute name expected");
            var e = R;
            if (u(), "=" != R)
              throw _("Equal sign = expected");
            if (u(), z != T.IDENTIFIER)
              throw _("Attribute value expected");
            var i = R;
            h(t, e, i), u(), "," == R && u();
          }
          if ("]" != R)
            throw _("Bracket ] expected");
          u();
        }
        return t;
      }
